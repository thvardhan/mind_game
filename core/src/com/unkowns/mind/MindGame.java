...
//        poly=new PolygonSprite();
    ...
    public boolean loadAssets() {
        try {
            ...
            assetManager.load(new AssetDescriptor<Text>("persona/ENFP.txt", Text.class, new TextLoader.TextParameter()));
            ...
            assetManager.load(new AssetDescriptor<Text>("persona/ESFP.txt", Text.class, new TextLoader.TextParameter()));
            assetManager.load(new AssetDescriptor<Text>("persona/ESTJ.txt", Text.class, new TextLoader.TextParameter()));
            assetManager.load(new AssetDescriptor<Text>("persona/ESTP.txt", Text.class, new TextLoader.TextParameter()));
            ...
            assetManager.load(new AssetDescriptor<Text>("persona/ISFJ.txt", Text.class, new TextLoader.TextParameter()));
            assetManager.load(new AssetDescriptor<Text>("persona/ISFP.txt", Text.class, new TextLoader.TextParameter()));
            assetManager.load(new AssetDescriptor<Text>("persona/ISTJ.txt", Text.class, new TextLoader.TextParameter()));
